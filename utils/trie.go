...
func (t *Trie) search(strand []int, maxdist int, match []DistSeq) []DistSeq {
...
func (t *Trie) searchRecursive(idx int, strand []int, maxdist int, didx int, distances [][]int, match []DistSeq) []DistSeq {
	colnum := len(strand) + 1
